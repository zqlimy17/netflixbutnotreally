        ...
        <div>
          <div className="row">
            ...
            <div className="col-sm-8 p-4">
              ...
              <p>
                Rated {this.state.voteAverage} &#9733; by {this.state.voteCount} Users.
              </p>
              ...
              {this.props.currentUser === "" ? (
              ...
              ) : this.props.currentUser.favorites.indexOf(this.props.match.params.movieId) === -1 ? (
                <button
                ...
                <button className="btn btn-warning btn-md" onClick={this.handleUnlike}>
