        ...
        <div className="row d-flex justify-content-center pt-5">
          <div className="col-4 form p-4">
            ...
            <form onSubmit={this.handleSubmit} className="my-4">
              ...
              <input type="submit" value="Sign In" className="btn btn-warning btn-block" disabled />
            </form>
            {this.state.message !== "" ? <p style={{ textAlign: "center", color: "red" }}>{this.state.message}</p> : ""}
            <div>
              <span style={{ color: "grey" }}>New to SMDB?</span> <Link to="/signup/">Sign up now</Link>.
            </div>
          </div>
        </div>
      </React.Fragment>
