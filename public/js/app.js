    ...
    return (
      <BrowserRouter>
        <div>
          ...
          <Switch>
            <Route exact path="/">
              <Home currentUser={this.state.currentUser} userState={this.userState} />
            </Route>
            <Route path="/login">{this.state.currentUser ? <Redirect to="/" /> : <Login userState={this.userState} />}</Route>
            <Route path="/signup">
